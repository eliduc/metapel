...
window.MetapelStore = (function () {
  ...
  // ключ зависит от среды (prod/stage): на общем origin eliduc.github.io
  // у stage свой ключ, иначе среды затирали бы данные друг друга
  var KEY = (window.MetapelEnv && window.MetapelEnv.storageKey) || 'metapel-app-v1';
